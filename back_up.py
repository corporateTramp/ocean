...
def create_tables(db_data="dbname=alex user=alex password=alexdb"):	
	...
	cur.execute("CREATE TABLE scan_sessions ( id SERIAL PRIMARY KEY, account_id integer, publications integer,subscribers integer, subscriptions integer, created_at timestamp, active_subscribers decimal(4) , er decimal(4) , avg decimal(4) );")
